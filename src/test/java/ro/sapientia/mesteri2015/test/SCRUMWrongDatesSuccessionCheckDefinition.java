...
public class SCRUMWrongDatesSuccessionCheckDefinition {
	...
	@Given("^I add a new story with wrong dates successions$")
	...
	@When("^I enter \"([^\"]*)\" in the start date datebox first$")
	public void I_enter_in_the_start_date_datebox_first(String startDate)
			throws Throwable {
		// Express the Regexp above with the code you wish you had
